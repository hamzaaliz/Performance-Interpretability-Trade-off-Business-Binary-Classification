...
os.environ.setdefault("MPLCONFIGDIR", "/tmp/ccd-workflow-matplotlib")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run the locked Default of Credit Card Clients workflow"
    )
    ...
    print(
        json.dumps(
            {"code_version": result["code_version"], "output_root": result["output_root"]},
            indent=2,
        )
    )
